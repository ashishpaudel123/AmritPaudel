...
export function DigitalMarketingPortfolio({ onBack }: DigitalMarketingPortfolioProps) {
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
            Digital Marketing 
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> Case Studies</span>
          </h2>
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
            Real results from real campaigns. Explore my data-driven digital marketing strategies 
            that have driven measurable growth for businesses.
          </p>
        </div>
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-8 md:p-12 text-white mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { number: "$1.5M+", label: "Revenue Generated" },
              { number: "150+", label: "Campaigns Launched" },
              { number: "420%", label: "Average ROI" },
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            Let's discuss how data-driven digital marketing strategies can transform your business growth.
          </p>
          <Button 
            size="lg" 
