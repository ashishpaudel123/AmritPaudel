...
import { ArrowRight, PlayCircle, TrendingUp, Users, Award } from "lucide-react"
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed">
                I help businesses grow their online presence through strategic digital marketing that drives real results and measurable ROI.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 py-6">
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">200+</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Clients Helped</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">5+</div>
              ...
              <div className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-slate-800 dark:text-white">Marketing Dashboard</h3>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
                      ...
                      <div className="text-xl font-bold text-green-800 dark:text-green-300">12.5%</div>
                    </div>
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
                      <div className="text-sm text-blue-600 dark:text-blue-400">ROI</div>
                      <div className="text-xl font-bold text-blue-800 dark:text-blue-300">324%</div>
                    </div>
                  </div>
                </div>
              </div>
