...
export function GraphicsDesignPortfolio({ onBack }: GraphicsDesignPortfolioProps) {
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
            Creative Design 
            <span className="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent"> Portfolio</span>
          </h2>
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
            Transforming ideas into stunning visual experiences. Explore my design work across 
            branding, marketing materials, and digital content.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 rounded-3xl p-8 md:p-12 mb-16 border border-slate-200 dark:border-slate-700">
          <div className="text-center">
            <Palette className="w-16 h-16 mx-auto mb-6 text-purple-600 dark:text-purple-400" />
            <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-4">
              Portfolio Showcase Coming Soon
            </h3>
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
              I'm currently curating my best design work to showcase here. In the meantime, 
              I'd love to discuss your design needs and show you relevant samples.
            </p>
            <Button 
              size="lg"
              onClick={() => openModal("View Design Portfolio")}
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            Whether you need a complete brand identity or a single graphic, I'm here to bring your vision to life.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg"
              variant="outline"
              onClick={() => openModal("View Full Portfolio")}
              className="px-8 py-3 text-lg font-semibold border-2 hover:bg-purple-50 dark:hover:bg-purple-900/20"
            >
              View Full Portfolio
            </Button>
          </div>
