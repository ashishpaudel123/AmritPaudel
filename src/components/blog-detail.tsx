                ...
                <nav className="space-y-2">
                  {tocItems.map((item) => (
                    <button
                      ...
                      className="block w-full text-left text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300 py-1"
                    >
                      {item.title}
                    </button>
                  ))}
